...
class Template:
    ...
    def add_coa_data(self):
        ...
        for solvent in self.solvents:
            ...
            self.solvent_sheets[solvent.name]["A7"] = f"Workbook generated by Headspace Helper {VERSION}"
    ...
    def add_area_height_data_a(self):
        ...
        try:
            for solvent in self.solvents:
                self.solvent_sheets[solvent.name][f"F62"] = getattr(solvent, "a8")[0]
                self.solvent_sheets[solvent.name][f"F63"] = getattr(solvent, "a7")[0]
                self.solvent_sheets[solvent.name][f"F64"] = getattr(solvent, "a6")[0]
                self.solvent_sheets[solvent.name][f"F65"] = getattr(solvent, "a5")[0]
                self.solvent_sheets[solvent.name][f"F66"] = getattr(solvent, "a4")[0]
                self.solvent_sheets[solvent.name][f"F67"] = getattr(solvent, "a3")[0]
                self.solvent_sheets[solvent.name][f"F68"] = getattr(solvent, "a2")[0]
                self.solvent_sheets[solvent.name][f"F69"] = getattr(solvent, "a1")[0]

                self.solvent_sheets[solvent.name][f"I62"] = getattr(solvent, "a8")[1]
                self.solvent_sheets[solvent.name][f"I63"] = getattr(solvent, "a7")[1]
                self.solvent_sheets[solvent.name][f"I64"] = getattr(solvent, "a6")[1]
                self.solvent_sheets[solvent.name][f"I65"] = getattr(solvent, "a5")[1]
