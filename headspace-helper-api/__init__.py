...
# These cells are referenced to sheet "solvent 1" in the unmodified empty "HS_Quantification Template".
# They are programmatically added to every newly created solvent sheet.
cells_with_reference = [
    "I5", "I6", "I7", "I8", "I9", "I10", "I11", "I12", "M21",  # Only for worksheet "Analytical report"
    ...
    "B78",  # Noise
    "A84", "B84", "C84", "D84",  # 7. Repeatability and control
    "A95", "A96", "A97", "A98", "A99",  # 8. Bracketing control - Control name
    "B95", "B96", "B97", "B98", "B99",  # 8. Bracketing control - Bracket
    "C95", "C96", "C97", "C98", "C99",  # 8. Bracketing control - V (uL)
    "D95", "D96", "D97", "D98", "D99",  # 8. Bracketing control - From Stock
    "E95", "E96", "E97", "E98", "E99",  # 8. Bracketing control - V added (mL)
    ...
    "K105", "K111", "K117", "K123", "K129",  # 9. Samples(s) - Area from Sample (a.u. *s)
    "L105", "L111", "L117", "L123", "L129",  # 9. Samples(s) - Spike Area (a.u. *s)
    "M105", "M111", "M117", "M123", "M129",  # 9. Samples(s) - Nom Spiked Conc (ug / mL)
    "N105", "N111", "N117", "N123", "N129",  # 9. Samples(s) - Spike Conc. Calcu. (ug/mL)
    "O105", "O111", "O117", "O123", "O129",  # 9. Samples(s) - Recovery (%)
    "P108", "P114", "P120", "P126", "P132",  # 9. Samples(s) - Conc. solvent (ug/mL)
    "Q108", "Q114", "Q120", "Q126", "Q132",  # 9. Samples(s) - Content ppm (w/w)
    "R108", "R114", "R120", "R126", "R132",  # 9. Samples(s) - Mean Content ppm (w/w)
    "S108", "S114", "S120", "S126", "S132",  # 9. Samples(s) - Mean Content % (w/w)
    "U108", "U114", "U120", "U126", "U132",  # 9. Samples(s) - Report result
]
